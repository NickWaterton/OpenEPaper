...
GITHUB_API_URL = "https://api.github.com/repos/NickWaterton/OpenEPaperLink/contents/resources/tagtypes"
GITHUB_RAW_URL = "https://raw.githubusercontent.com/NickWaterton/OpenEPaperLink/master/resources/tagtypes"
...
class TagTypesManager:
    ...
    def __init__(self) -> None:
        ...
        self._legacy_storage_file = LEGACY_TAG_TYPES_FILE
        '''
    ...
    async def load_stored_data(self) -> None:
        ...
        try:
            ...
            with open(self._legacy_storage_file, "r") as f:
    ...
    async def _save_to_store(self) -> None:
        ...
        try:
            ...
            with open(self._legacy_storage_file, "w") as f:
    ...
    async def ensure_types_loaded(self) -> None:
        ...
        Raises:
            exception: If tag types could not be loaded
        """
        async with self._lock:
            ...
            if not self._tag_types:
                raise ValueError('could not load tags definitions')
            ...
            if not self._last_update or datetime.now() - self._last_update > CACHE_DURATION:
                ...
                if not fetch_success and not self._tag_types:
                    raise ValueError("tagtypes_refresh_failed")
...
async def get_tag_types_manager() -> TagTypesManager:
